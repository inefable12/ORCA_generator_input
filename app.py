...
if menu == "SI":
    ...
    if uploaded_file is not None:
        ...
        st.write("Este archivo XYZ se muestra por defecto, puedes ingresar tu molécula arriba")
        xyz_text = default_xyz
    
    xyz_text = st.text_area("Contenido del archivo XYZ", xyz_text, height=150)
